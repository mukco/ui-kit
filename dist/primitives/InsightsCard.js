 ...
 */
export function InsightsCard({ title = "AI Insights", loading = false, isRefreshing = false, cached = false, generatedAt, description, numbered = false, onRegenerate, sections, empty = "Nothing yet.", className, }) {
