 ...
 */
export async function readyForNewBuild(timeoutMs = 5_000, nav = typeof navigator === "undefined" ? undefined : navigator) {
...
function waitForControllerChange(sw, timeoutMs) {
