...
export function Card({ children, className, title, subtitle, help, actions, headBar }) {
    return (_jsxs("section", { className: cn("ui-card", headBar && "ui-card--barred", className), children: [(title || actions) && (_jsxs("div", { className: cn("ui-card-head", headBar && "ui-card-head--bar"), children: [_jsxs("div", { className: "ui-card-head-text", children: [title && (_jsxs("h3", { className: "ui-card-title", children: [title, help] })), subtitle && _jsx("p", { className: "ui-card-subtitle", children: subtitle })] }), actions && _jsx("div", { className: "ui-card-actions", children: actions })] })), children] }));
}
