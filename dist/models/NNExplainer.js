...
export function NNExplainer({ onClose }) {
    return (_jsxs("div", { className: "ui-card ui-nnexplainer", children: [_jsxs("div", { className: "ui-mlhead", children: [_jsx("h2", { className: "ui-expandable-title", children: "How machine learning models work" }), onClose && (_jsx("button", { type: "button", onClick: onClose, className: "ui-iconbtn", "aria-label": "Close explainer", children: "\u2715" }))] }), _jsx("div", { className: "ui-nngrid", children: sections.map((s) => (_jsxs("div", { children: [_jsx("h3", { className: "ui-nntitle", children: s.title }), _jsx("p", { className: "ui-nncontent", children: s.content })] }, s.title))) })] }));
}
